 ...
 * Intuition:
 * 
 * -> We can use Hashtable ( map in C++, HashMap in Java) to check duplicate
 ...
 * Approach:
 * 
 * -> We will create a hash table of size n and store elements in it. Before
 * inserting a new element in the hash table, if it already exists in the hash
 * table.
 * 
